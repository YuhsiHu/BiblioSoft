		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				...
				<ul class="nav">
					...
					<li><a href="registerLib.jsp" class="active"><i
				...
				<div class="container-fluid">
					<div class="panel">
						<div class="panel-heading">
							<h1 align="center" class="page-title">Register Librarian</h1>
						</div>
						<form onsubmit = "return checkInput(this)" method="post" action="RegisterLib">
										...
										<td width="300px">
											<div align="center">
												<label style="font-size: 20px" class="control-label"
													for="LibrarianName">Librarian Name</label>
											</div>
										</td>
										<td width="300px">
											<div class="input-group">
												<input type="text" class="form-control" id="LibName"
													name="LibName" placeholder="Librarian's Name">
											</div>
										</td>
									</tr>
								</table>
