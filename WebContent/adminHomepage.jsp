			...
			<div id="navbar-menu">
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<% if(session.getAttribute("Admin_Name").equals("Taiho")) { %>
							<img src="assets/img/Taiho.png"
							class="img-circle" alt="Avatar">
						<% } else { %> 
							<img src="assets/img/user.png"
							class="img-circle" alt="Avatar">
						<% } %> 
							<span>${sessionScope.Admin_Name}</span></a></li>
				</ul>
			</div>
		</div>
		</nav>
			...
			<div class="sidebar-scroll">
				...
				<ul class="nav">
					<li><a href="index.jsp" class="active"><i
							class="lnr lnr-home"></i> <span>Administrator Index</span></a></li>
						...
						<div class="profile-header">
							...
							<div class="profile-main">
								...
								<img src="assets/img/user-medium.png" class="img-circle"
									alt="Avatar">
								<% } %>
								<h3 class="name" id="name">${sessionScope.Admin_Name}</h3>
								<span>${sessionScope.Admin_ID}</span>
							</div>
						</div>
						<div class="panel-body">
							<div class="profile-detail"></div>
							<h1 align="center" class="page-title">Welcome Administrator !</h1>
						</div>
					</div>
					<!-- END OVERVIEW -->
				</div>
