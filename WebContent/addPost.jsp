...
<body>
	...
	<div id="wrapper">
		...
		<div class="brand">
			<li><li><a href="librarianHomepage.jsp"><img src="assets/img/BiblioSoft Logo.png"
						...
						<div class="col-md-12" >
							...
							<!-- INPUTS -->
								...
								<div class="panel-heading">
									<h3 class="panel-title">Input title</h3>
								</div>
								...
								<div class="panel-body">
                                    <div class="col-md-12">
											<div class="input-group">
												<input class="form-control" style="width:600px;" name="title" type="text" placeholder="Post Title">
											</div>
                                    </div>
								</div>
                            </div>
                            ...
                            <div class="panel-heading">
								...
								<div class="panel-body" >
									<textarea name="body" style="width:900px;height:260px;">
									</textarea>
                                    <br>
                                    <p class="demo-button">
