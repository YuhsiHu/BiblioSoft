				...
				<div class="container-fluid">
					<div class="panel">
						<div class="panel-heading">
							<h1 align="center" class="page-title">Modify Librarian</h1>
						</div>
						<form method="post" action="ModifyLib">
							<div class="panel-body">
								<table align="center">
									<tr>
										<td width=250px height=64px>
											<div class="form-group has-success has-feedback">
												<label class="control-label" for="LibID">Librarian
														ID</label>
											</div>
										</td>
										<td width=350px height=64px>
											${sessionScope.SearchLib_ID}
										</td>
									</tr>
									<tr>
										<td width=250px height=64px>
											<div class="form-group has-success has-feedback">
												<label class="control-label" for="newLibName">Librarian
														New Name</label>
											</div>
										</td>
										<td width=350px height=64px>
											<div class="form-group has-success has-feedback">
												<input type="text" name="newLibName"
													class="form-control" placeholder="Librarian
														New Name">
											</div>
										</td>
									</tr>
									<tr>
										<td width=250px height=64px>
											<div class="form-group has-success has-feedback">
												<label class="control-label" for="ConfirmNewName">Confirm
														New Name</label>
											</div>
										</td>
										<td width=350px height=64px>
											<div class="form-group has-success has-feedback">
												<input type="text" name="ConfirmNewName"
