					...
					<!-- OVERVIEW -->
						...
						<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Result Of Adding</h3>
								</div>
									...
									<table class="table">
										...
										<tbody>
											<tr style="font-size:25px;">
												...
												<td>${tele}</td>
												<td>${email}</td>
												<td><img src='http://barcode.tec-it.com/barcode.ashx?data=${readerID}' alt='Barcode Software by TEC-IT' border='0' /></td>
											</tr>										
										</tbody>
									</table>
									<a href="home.jsp" class="demo-button" >
