                                ...
                                <table class="table table-striped">
                                    ...
                                    <%
                                        ...
                                        if(request.getParameter("Reader_id")==""){
                                            out.print("<script language='javascript'>alert('Librarian ID Can Not Be Empty!');window.location.href='fineRecord.jsp';</script>");
                                        }else{
                                        if (request.getParameter("Reader_id") != null)
                                            Reader_id = Integer.valueOf(request.getParameter("Reader_id"));
                                        Collection<RecordTable> recordTables = recordDAO.ifNeedtoSendEmail(Reader_id);
                                    ...
                                    <tr>
                                        ...
                                        <td><%=new String(df.format(recordDAO.getDeadDate(Reader_id, recordTable.getBook_id())))%>
                                        </td>
                                        <td><%=defaultValue.getLongesttime() + "days"%>
                                        </td>
                                        <th><%=recordDAO.getFine(Reader_id, recordTable.getBook_id())%>
                                        </th>
                                    </tr>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        int counts = 1;
                                        Collection<RecordTable> recordTabless = recordDAO.getReturnHistory(Reader_id);
                                        for (RecordTable recordTable : recordTabless) {
