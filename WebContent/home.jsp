				...
				<div class="container-fluid">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="weekly-summary text-right">
										<span class="number">356</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 12%</span>
										<span class="info-label">Total Add</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">1045</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 23%</span>
										<span class="info-label">Total Borrow</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">763</span> <span class="percentage"><i class="fa fa-caret-down text-danger"></i> 8%</span>
										<span class="info-label">Total Active</span>
                                    </div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Recent Borrow</h3>
									<div class="right">
						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Borrow vs. Active</h3>
									<div class="right">
										<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
										<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
									</div>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Type Of Borrowed</h3>
									<div class="right">
										<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
										<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
									</div>
								...
								<div class="panel-body">
									<ul class="list-unstyled task-list">
										<li>
											<p>Type1 <span class="label-percent">23%</span></p>
										...
										<li>
											<p>Type2 <span class="label-percent">80%</span></p>
											<div class="progress progress-xs">
										...
										<li>
											<p>Type3 <span class="label-percent">100%</span></p>
											<div class="progress progress-xs">
										...
										<li>
											<p>Type4 <span class="label-percent">45%</span></p>
											<div class="progress progress-xs">
										...
										<li>
											<p>Type5 <span class="label-percent">10%</span></p>
											<div class="progress progress-xs">
						...
						<div class="col-md-4">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Book In Lib</h3>
									<div class="right">
										<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
										<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
									</div>
