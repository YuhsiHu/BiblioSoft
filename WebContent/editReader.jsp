						...
						<li>
							...
							<div id="subPages2" class="collapse in">
								<ul class="nav">
									...
									<li><a href="editReader.jsp" class="active">Edit Reader</a></li>
						...
						<div class="col-md-12" >
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>@steve</td>
                                                    <td>@steve</td>
                                                    <th><button type="button" class="btn btn-primary"><i class="fa fa-refresh"></i> Update</button></th>
                                                </tr>
                                                <tr>
                                                    <td>1602</td>
                                                    <td>Philips</td>
                                                ...
                                                <tr id="location">
                                                    ...
                                                    <td>@steve</td>
                                                    <td>@steve</td>
                                                    <th><button type="button" onclick=onTopClick()  class="btn btn-primary" ><i class="fa fa-refresh"></i> Update</button></th>
                            ...
                            <div class="panel" >
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <br>
                                        <input type="text" class="form-control" placeholder="Reader Name">
                                        <br>
                                        <input type="text" class="form-control" placeholder="Sex">
                                        <br>
                                        <input type="text" class="form-control" placeholder="Phone Numebr">
                                        <br>
