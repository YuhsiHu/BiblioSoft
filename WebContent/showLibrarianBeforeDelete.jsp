				...
				<div class="container-fluid">
					<div class="panel">
						<div class="panel-heading">
							<h1 align="center" class="page-title">Delete The Librarian</h1>
						</div>
					...
					<div class="panel">
						...
						<div class="panel-body no-padding">
							<form method="post" action="DeleteLib">
								<table class="table">
									<thead>
										<tr>
											<th>Librarian ID</th>
									...
									<tbody>
										<tr>
											<td>${sessionScope.DeleteLib_ID}</td>
											<td>${sessionScope.DeleteLib_Name}</td>
