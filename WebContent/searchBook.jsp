									...
									<table class="table">
										<thead>
											...
											session.setAttribute("bookcount", 0);
												...
												if(Integer.valueOf(String.valueOf(session.getAttribute("bookcount")))!= 0){
												for(int i=0; i<Integer.valueOf(String.valueOf(session.getAttribute("bookcount")));i++){
											%>
											<tr>
											...
											<%} 
												session.removeAttribute("bookisbn");
												session.removeAttribute("bookname");
												session.removeAttribute("bookauthor");
												session.removeAttribute("bookpublisher");
												session.removeAttribute("bookedition");
												session.removeAttribute("bookstatue");
												}%>
										</thead>
