				...
				<div class="container-fluid">
					<div class="panel">
						<div class="panel-heading">
							<h1 align="center" class="page-title">Forget Password</h1>
						</div>
						<form method="post" action="ReaderRetrievePassword">
							<div class="panel-body">
								<table align="center">
									<tr>
										<td width=250px height=64px>
											<div class="form-group has-success has-feedback">
												<label class="control-label" for="Reader ID" >Reader
													ID</label>
											</div>
										</td>
										<td width=350px height=64px>
											<div class="form-group has-success has-feedback">
												<input type="text" name="reader_id" class="form-control"
													placeholder="Reader ID" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
											</div>
										</td>
									</tr>
									<tr>
										<td width=250px height=64px>
											<div class="form-group has-success has-feedback">
												<label class="control-label" for="telephone">Telephone
													</label>
											</div>
										</td>
										<td width=350px height=64px>
											<div class="form-group has-success has-feedback">
												<input type="password" name="telephone"
													class="form-control" placeholder="Telephone" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
											</div>
										</td>
									</tr>	
								</table>
