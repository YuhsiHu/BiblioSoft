					...
					<div class="row">
						<div class="col-md-12" >
							...
							<!-- INPUTS -->
								...
								<form method="post" action="DeleteOrEditPost">
								<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">The post title</h3>
								</div>
								
								<div class="panel-body">
                                    <div class="col-md-12">
											<div class="input-group">
												<input name="newTitle" class="form-control" style="width:600px;" name="title" type="text" placeholder="Post Title" value="${sessionScope.title}">
											</div>
                                    </div>
                            ...
                            <div class="panel" >
                            <div class="panel-heading">
                                    <h3 class="panel-title">The Body</h3>
                                </div>
								<div class="panel-body" >
									<textarea name="newBody" style="width:900px;height:260px;" >${sessionScope.body}
									</textarea>
                                    <br>
