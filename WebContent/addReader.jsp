					...
					<li><a href="librarianHomepage.jsp" class=""><i
						...
						<li>
							...
							<div id="subPages2" class="collapse in">
								<ul class="nav">
									<li><a href="addReader.jsp" class="active">Add Reader</a></li>
						...
						<li>
							...
							<div id="subPages3" class="collapse">
								<ul class="nav">
								    ...
								    <li><a method="post" href="searchPost.jsp" class="">Search Post</a></li>
								</ul>
							</div>
						</li>						
						...
						<div class="col-md-12" >
							...
							<div class="panel">
								...
								<div class="panel-body">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Reader Name"  name="readerName">
                                    <br>
                                    <input type="text" class="form-control" placeholder="Email"     name="email">
                                    <br>
                                    
									<br>
									<!-- only selected just submit is abled -->
									<label class="fancy-checkbox">
										<input name="paid" type="checkbox" onclick="check()">
