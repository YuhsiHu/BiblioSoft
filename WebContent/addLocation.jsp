	...
	<div id="wrapper">
						...
						<li>
							...
							<div id="subPages1" class="collapse">
								<ul class="nav">
									...
									<li><a href="addLocation.jsp" class="active">Add Book Location</a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Add a location</h3>
					<div class="row">
						<div class="col-md-12" >
								...
								<div class="panel-body">
                                    <div class="col-md-12">
											<div class="input-group">
												<input class="form-control" style="width:600px;" name="location" type="text" placeholder="Location name">
											</div>
                                    </div>
								</div>
                            </div>      
