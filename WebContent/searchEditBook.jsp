...
<body>
	...
	<div id="wrapper">
					...
					<li><a href="#subPages1" data-toggle="collapse" class="active"><i
						...
						<div id="subPages1" class="collapse in">
							<ul class="nav">
								...
								<li><a href="searchEditBook.jsp" class="active">Search
										and Edit Book</a></li>
							</ul>
						</div></li>
					...
					<li><a href="#subPages2" data-toggle="collapse"
						...
						<div id="subPages2" class="collapse ">
							<ul class="nav">
								...
								<li><a href="borrowAndReturnRecord.jsp" class="">Borrow
										and Return Record</a></li>
								<li><a href="fineRecord.jsp" class="">Fine Record</a></li>
								<li><a href="borrowAndReturn.jsp" class="">Book Borrow
										and Return</a></li>
		...
		function update(){
			...
			<% Object name = request.getAttribute("book_name");%>
			var name = "<%=name%>";
