...
<head>
    <title>Borrow And Return Record</title>
    <meta charset="utf-8">
...
<div id="wrapper">
                    ...
                    <li>
                        ...
                        <div id="subPages2" class="collapse in">
                            <ul class="nav">
                                ...
                                <li><a href="borrowAndReturnRecord.jsp" class="active">Borrow and Return Record</a></li>
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">B & R Record</h3>
                <div class="row">
                    <div class="col-md-12">
                        <!-- TABLE STRIPED -->

                        <form method="POST" action="borrowAndReturnRecord.jsp">
                            <div class="panel">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Borrowing</h3>
                            </div>
                            <div class="panel-body">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>null</td>
                                        <th><%=defaultValue.getLongesttime() + "days"%>
                                        </th>
                                    </tr>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped">
                                    ...
                                    <%
                                        ...
                                        Collection<RecordTable> recordTabless = recordDAO.getRecordByReaderID(Reader_id);
