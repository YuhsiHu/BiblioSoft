...
<body>
	...
	<div id="wrapper">
						...
						<li>
							...
							<div id="subPages2" class="collapse in">
								<ul class="nav">
									...
									<li><a href="librarianEditReader.jsp" class="active">Edit Reader</a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title"> Edit a reader</h3>
					<div class="row">
						<div class="col-md-12" >
							...
							<div class="panel">
								...
								<form method="POST" action="FindReaderForEdit" > 
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th><button type="submit" class="btn btn-primary" onclick="update()"><i class="fa fa-refresh"></i> Update</button></th>
                                                </tr>
                            ...
                            <div class="panel" >
                                    ...
                                    <form method="POST" action="EditReader" > 
                                    <div class="panel-body">
                                        <input type="text" class="form-control" name = "id" id = "id" placeholder="Reader ID"  readonly= "true ">
                                        <br>
                                        <input type="text" class="form-control" name = "password" id = "password" placeholder="Password">
                                        <br>
                                        <input type="text" class="form-control" name = "name" id = "name" placeholder="Reader Name">
                                        <br>
                                     <!--  <input type="text" class="form-control" id = "sex" placeholder="Sex">
                                        <br> -->
                                        <input type="text" class="form-control" name = "tele"  id = "tele" placeholder="Phone Numebr"  readonly= "true ">
                                        <br>
                                        <input type="text" class="form-control" name = "email" id = "email" placeholder="Email">
                                        <br>
                                  <!--  <input type="text" class="form-control" placeholder="Max Borrow">
                                        <br>
	...
	function update(){
		...
		<% Object name1 = request.getAttribute("readerName");%>
		var name = "<%=name1%>";
		$("#name").attr("value",name);
		
		
		
		<% Object tele = request.getAttribute("tele");%>
		var tele = "<%=tele%>";
