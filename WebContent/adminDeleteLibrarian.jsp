...
<body>
					...
					<li><a href="#subPages" data-toggle="collapse"
						...
						<div id="subPages" class="collapse in">
							<ul class="nav">
								...
								<li><a href="manage-delete.jsp" class="active">Delete</a></li>
							</ul>
						</div></li>
			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="panel">
						...
						<form onsubmit = "return checkInput(this)" method="post" action="DeleteLib">
										...
										<td width="300px">
											<div align="center">
												<label style="font-size: 20px" class="control-label"
													for="LibrarianName">Librarian ID</label>
											</div>
										</td>
										<td width="300px">
											<div class="input-group">
												<input type="text" class="form-control" id="LibID"
													name="LibID" placeholder="Librarian's ID">
											</div>
										</td>
									</tr>
								</table>
	...
	function checkInput(form){
		if(form.LibID.value==""){
			alert("Please Input Librarian's ID!");
			form.LibID.focus();
			return false;
		}
	}	
