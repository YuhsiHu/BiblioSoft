 ...
 */
public class FindReaderForDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindReaderForDelete() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ReaderDAO readerDAO= new ReaderDAO();
			...
			if(reader.getTele() == null) {
				...
				out.print("<script>alert(' The account does not exist!');window.location='deleteReader.jsp';</script>");
		  ...
		  {
			PrintWriter out=response.getWriter();
			out.print("<script>alert('Please enter the number!');window.location='deleteReader.jsp';</script>");
			  }
	}
