...
//			System.out.print(style+name);
			...
			out.print("<script>alert('Please select the search type!');window.location='readerSearchBook.jsp';</script>");
		}
		System.out.println(books.size());

		if(books.isEmpty()) {
			out.print("<script>alert('No related books!Please try new search terms! !');window.location='readerSearchBook.jsp';</script>");
		}else {
